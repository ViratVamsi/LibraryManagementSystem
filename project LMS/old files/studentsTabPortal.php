...
<body>
            ...
            <div class="containter-fluid">
                ...
                <div id="wrapper">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#student-home">Hii
                            <?=$_SESSION['user_id']['$id']?></a> <!-- navbar-brand is used for styling content in navbar header class -->
                    </div>
    ...
    <section id="student-home">
        <div class="student-home-cover">
                        <div class="search-bar bar-content">
